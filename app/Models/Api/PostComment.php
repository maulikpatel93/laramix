...
class PostComment extends Model
{
    ...
    public function post_comment_reply()
    {
        ...
        return $this->hasMany(PostCommentReply::class, 'post_comment_id', 'id')->with($witharray);
    }

    public function totalLike(): Attribute
    {
        return new Attribute(
            get: fn ($value, $attributes) => PostCommentLike::where(['post_comment_id' => $attributes['id']])->count(),
        );
    }
}
