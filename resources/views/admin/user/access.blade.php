...
$formRoute = route('admin.user.accessupdate', ['id' => encode($rolemodel->id)]);
@endphp
@section('title')
    {{ $title }}
@endsection
        ...
        <div class="col-12">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12">
                            <div class="float-end">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="permissionid" class="custom-control-input " value="1"
                                        aria-invalid="false">
                ...
                foreach ($permissionmodel as $key => $value) {
                    ...
                    if ($value->module_name_unique) {
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12 bg-light p-2 mt-2">
                            <div class="float-start">
                                <h5 class="font-weight-bold">Access Control : {{ $value->module_name_unique }}</h5>
                            </div>
                        </div>
                        <?php
                    }
            ...
            ?>
                ...
                <div class="card-footer text-center">
                    {{                     Form::button('Save', ['type' => 'submit', 'class' => 'btn btn-success', 'id' => $formName . '-submit']) }}
                    {{ link_to_route('admin.user.index', 'Cancel', $parameters = [], ['class' => 'btn btn-danger','id' => $formName . '-close']) }}
